...
using BiseHyderabad.Infrastructure.Services;
using BiseHyderabad.Web.Authentication;
using BiseHyderabad.Web.Authorization;
using BiseHyderabad.Web.Components;
using BiseHyderabad.Web.Middleware;
using BiseHyderabad.Web.Services;
using BiseHyderabad.Web.Validators;
...
{
    connectionString = "Server=(localdb)\\mssqllocaldb;Database=BiseHyderabadDb;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=True";
}
...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    .AddCookie(options =>
    {
        ...
        options.Cookie.Name = "BiseHyderabad.Auth";
